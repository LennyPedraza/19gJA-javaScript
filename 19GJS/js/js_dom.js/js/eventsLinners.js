...
//Nuestro documento ya esta cargado(listo)
//DOMContentLoaded
//click
//focus
...
//element.adddEventListener('typeEvent','callback/function')
let botonCargar = document.querySelector('#btnAlbumes')
//Cuando le des clicl en el boton #btnAlbumes
botonCargar.addEventListener('click',loadAlbumes)

/**
 * Pintar todos los posts cuando carge el documento
 */
