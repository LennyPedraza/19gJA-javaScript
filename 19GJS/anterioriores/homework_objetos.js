...
return `hay ${employes} empleados con un salario total de ${sumaSalario}`
...
let printLanguages = koder.languages

printLanguages.forEach((cv)=>{
...
let cloneKoder = {}
cloneKoder.languages=[]
cloneKoder.languages.push("JavaScript", "Python", "Ruby")
cloneKoder.isMentor= true
cloneKoder.level = 3
cloneKoder.avatar='https://picsum.photos/200/300'
console.log(cloneKoder)
